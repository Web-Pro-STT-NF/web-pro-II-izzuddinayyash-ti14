...
<head>
    ...
    <title>Predikat Nilai | Izzuddin Ayyash</title>
...
<form class="form-horizontal" method="POST" action="predikat.php">
...
if ($uts >=0 and $uts <=35) {
    ...
    echo "Grade : E";
    echo "<br> Predikat anda Sangat Kurang";
} else if ($uts >=36 and $uts <=55) {
    echo "<br> Nilai Anda : $uts <br>";
    echo "Grade : D";
    echo "<br> Predikat anda Kurang";
} else if ($uts >=56 and $uts <=69) {
    echo "<br>Nilai Anda : $uts <br>";
    echo "Grade : C";
    echo "<br> Predikat anda Cukup";
    ...
    echo "<br>Nilai Anda : $uts <br>";
    echo "Grade : I";}
    echo "<br> Predikat anda Tidak Ada";
